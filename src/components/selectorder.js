        ...
        <div>
            ...
            <div class="selectionContainer">
                <div class="selectItem">
                    <p>Angel</p>
                    <img class="selectImage" src={Angel} alt="" onClick={SelectedOrderCallBack.bind(this, 1)} />
                </div>
                <div class="selectItem">
                    <p>Human</p>
                    <img class="selectImage" src={Human} alt="" onClick={SelectedOrderCallBack.bind(this, 2)} />
                </div>
                <div class="selectItem">
                    <p>Demon</p>
                    <img class="selectImage" src={Demon} alt="" onClick={SelectedOrderCallBack.bind(this, 3)} />
                </div>
            </div>
        </div>
    )
